...
#define LV_DISP_DEF_REFR_PERIOD      3 // 30  //USR     /*[ms]*/

/* Dot Per Inch: used to initialize default sizes.
 * E.g. a button with width = LV_DPI / 2 -> half inch wide
 * (Not so important, you can adjust it to modify default sizes and spaces)*/
#define LV_DPI              70//130 //130     /*[px]*/
...
#define LV_DISP_MEDIUM_LIMIT 35 //50
...
#define LV_USE_GPU             0// 1   /*Only enables `gpu_fill_cb` and `gpu_blend_cb` in the disp. drv- */
...
#define LV_USE_FILESYSTEM       0 // 1 //USR
