 ...
 *
 * SOFTWARE AND DOCUMENTATION ARE PROVIDED ï¿½AS IS?WITHOUT WARRANTY OF ANY
...
#include "main.h"
#include "stm32f2xx.h"
#include "../SSD1963_DRV/SSD1963_CMD.h"


/*
*****************************************************************************
		DISPLAY ~ FSMC ~ Configuration
*****************************************************************************
*/

#define TFT_LCD_REG	 *(__IO uint8_t *)(0x60000000)
#define TFT_LCD_RAM	 *(__IO uint8_t *)(0x60010000)

/*
*****************************************************************************
		DISPLAY ~ RES ~ Configuration
*****************************************************************************
*/
...
//#define  ARIAL19x19
//#define  TIMES_NEW_ROMAN18x18
//#define  CALIBRI16X17
//#define  SMALL_FONTS9X9
#define SMALL_FONTS9X9_WITH_SYMBOL
//#define    SMALL_FONTS8X9
//#define  SMALL_FONTS7X6


/*
*****************************************************************************
		STM32F030RCT6 ~ Porting Interface
*****************************************************************************
*/

//LCD_DC  ~ Data/Command select
#define IC_A0_SET		HAL_GPIO_WritePin(GPIOD,LCD_DC_RS_Pin,GPIO_PIN_SET);
#define IC_A0_RESET		HAL_GPIO_WritePin(GPIOD,LCD_DC_RS_Pin,GPIO_PIN_RESET);


//LCD_WR
#define IC_WR_SET		HAL_GPIO_WritePin(GPIOD,LCD_WR_Pin,GPIO_PIN_SET);
#define IC_WR_RESET		HAL_GPIO_WritePin(GPIOD,LCD_WR_Pin,GPIO_PIN_RESET);

//LCD_RD
#define IC_RD_SET		HAL_GPIO_WritePin(GPIOD,LCD_RD_Pin,GPIO_PIN_SET);
#define IC_RD_RESET		HAL_GPIO_WritePin(GPIOD,LCD_RD_Pin,GPIO_PIN_RESET);

//LCD_CS#
#define IC_CS_SET		HAL_GPIO_WritePin(GPIOD,LCD_CS_Pin,GPIO_PIN_SET);
#define IC_CS_RESET		HAL_GPIO_WritePin(GPIOD,LCD_CS_Pin,GPIO_PIN_RESET);

//LCD_RST#
#define IC_RST_SET		HAL_GPIO_WritePin(GPIOF,LCD_RST_Pin,GPIO_PIN_SET);
#define IC_RST_RESET	HAL_GPIO_WritePin(GPIOF,LCD_RST_Pin,GPIO_PIN_RESET);

#if 0//For FSMC not required

//Data Bus
#define DATA_BUS(__X__)   		   HAL_GPIO_WritePin(GPIOB,LCD_DB0_Pin,((__X__ & (1<<0))));\
										HAL_GPIO_WritePin(GPIOB,LCD_DB1_Pin,((__X__ & (1<<1))));\
										HAL_GPIO_WritePin(GPIOB,LCD_DB2_Pin, ((__X__ & (1<<2))));\
										HAL_GPIO_WritePin(GPIOB,LCD_DB3_Pin, ((__X__ & (1<<3))));\
										HAL_GPIO_WritePin(GPIOB,LCD_DB4_Pin, ((__X__ & (1<<4))));\
										HAL_GPIO_WritePin(GPIOB,LCD_DB5_Pin, ((__X__ & (1<<5))));\
										HAL_GPIO_WritePin(GPIOB,LCD_DB6_Pin, ((__X__ & (1<<6))));\
										HAL_GPIO_WritePin(GPIOA,LCD_DB7_Pin, ((__X__ & (1<<7))));
#endif
...
*********************************************************************/
#define BLACK_565               RGB565CONVERT(0,    0,      0)
#define BRIGHTBLUE_565          RGB565CONVERT(0,    0,      255)
#define BRIGHTMAGENTA_565       RGB565CONVERT(255,  0,      255)
#define RED_565                 RGB565CONVERT(128,  0,      0)
...
#define GRAY3	0x808080
#define CYAN	0x00FFFF
#define MAGENTA	0xFF00FF
#define YELLOW	0xFFFF80

#define VIOLET	0xFF82FF
#define INDIGO  0x82004B

#define LIGHTBLUE           0x8080FF
#define LIGHTGREEN          0x80FF80
#define LIGHTCYAN           0x80FFFF
...
//GLCD Font Write API
void GLCD_ConfigAndWriteTextApi(uint16_t x, uint16_t y, char *str );
void SetFontColor(uint32_t ui32Color,uint32_t ui32BckColor);

uint32_t GetFontColor(uint8_t ui8BckOrFront);
...
* Note: none
********************************************************************/
#define LCD_WriteCommand(cmd)							SSD1963_Write_Command(cmd);
...
#define LCD_WriteData(data) 		SSD1963_Write_Data(data);
...
void glcd_draw_string_xy(uint16_t x, uint16_t y, char *c);
